...
<head>
  ...
  <title>Dissertation - Elite Researcher</title>
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          <div class="col-lg-8">
             <?php
                foreach ($data['docs'] as $doc) : 
                  if($doc['category'] == 'Dissertations'): $modal_id[] = ''.$doc['id']; ?>
                        ...
                        <div class="col-lg-12">
                          ...
                          <div class="d-flex flex-row justify-content-between align-items-between border-top" id="options">
                            ...
                            <div class="mt-2 d-flex flex-row justify-content-between align-items-between">
                              ...
                              <form id="saveform<?= $doc['id']; ?>" action="<?php echo site_url('book/save'); ?>" method="post" class="d-flex flex-row justify-content-between align-items-center p-0 m-0">
                                ...
                                <button class="p-0 mb-3 d-inline-block" id="bookmark<?= $doc['id']; ?>" name="bookmark" type="submit"><i class="bi bi-bookmark-fill" title="Bookmark"></i></button>
                              </form>
                            </div>
                          </div> 
                        </div>
          ...
          <div class="col-lg-4">
            <div class="col-12 mb-3 contact">
              <form id="search-form" action="<?php echo site_url('search/dissertation/'); ?>" class="php-email-forms" method="post">
