...
<head>
  ...
  <title>Capstone - Elite Researcher</title>
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          <div class="col-lg-8">
            <?php foreach ($data['docs'] as $doc) : 
              if($doc['category'] == 'Capstones'): $modal_id[] = ''.$doc['id']; ?>
          ...
          <div class="col-lg-4">
            <div class="col-12 mb-3 contact">
              <form id="search-form" action="<?php echo site_url('search/capstone'); ?>" class="php-email-forms" method="post">
