            ...
            if(res.error == false) {
              $('#message').show();
                ...
                setTimeout(function(){
                  ...
                  if(res.role == 1)
                    location.replace('<?php echo "http://localhost/archive/nav/index"; ?>');
                  else if(res.role == 2)
                    location.replace('<?php echo "http://localhost/archive/nav/document"; ?>');
                  else
                    location.replace('<?php echo "http://localhost/archive/nav/dashboard"; ?>');
                }, 3000);
              $('#email').val("");
              $('#password').val("");
            } else {
