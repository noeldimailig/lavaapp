            ...
            <div class="row">
                <nav id="sidebarToggler" class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse pt-0 pb-5">
                    ...
                    <div class="side-slide-down pb-5">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="<?php echo site_url('nav/pending'); ?>">
                ...
                <main role="main" class="main col-md-9 ml-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-0 pb-2 mb-3 border-bottom">
                        <h5 class="h3 color-darkgray mt-0 mb-0">Pending Document Lists</h5>
                    </div>
                    <div class="container-fluid">
                        <div class="row pb-3">
                            <div class="col-12 p-0 mt-2">
                                <div class="card border-top-bottom-blue">
                                    <div class="card-header p-0">
                                        ...
                                        <div class="card-label">Pending Lists</div> 
                                    </div>
                                    <div class="card-body p-4">
                                        <div class="table-responsive">
                                            <table id="pending" class="table table-hover table-sm mb-0">
                                                <thead>
                                                    <tr>
                                                        <th>ID</th>
                                                        <th>Title</th>
                                                ...
                                                <tbody>
                                                    <?php foreach ($data['docs'] as $result) : ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                            <a href="<?php echo site_url('nav/publish/'. encrypt_id($result['id']).'/'.$result['username'].'/'.$result['email']);?>">
                                                                        <i class="fs-5 material-icons text-info" data-bs-toggle="tooltip" title="Publish Document">&#xe255</i>
                                                                    </a>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach ?>
