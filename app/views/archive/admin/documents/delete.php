        ...
        <main role="main" class="main col-md-9 ml-sm-auto col-lg-10 px-md-4">
            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Update Document Details</li>
                </ul>
            </nav>
            <!-- End BreadCrumb -->
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-0 pb-2 mb-3 border-bottom">
                <h5 class="h3 color-darkgray mt-0 mb-0"> Form <small>Update Document Details</small></h5>
                                ...
                                <div class="card border-top-bottom-blue">  <!-- <div class="card text-white bg-dark"> -->
                                    ...
                                    <div class="card-body">
                                        <?php 
                                            ...
                                            //   $insertDoc = $db->updateDocument($prev_filename, $move, $title, $description, $authors, $year, $pub, $status, $filename, $doc_id, $file_id, $updated, $id);

                                            //   echo $insertDoc;
                                            // }
                                        ?>
                                         <!-- Form -->
                                    <form action="<?php echo site_url('nav/document_delete'); ?>" method="post" class="outer-form" id="validate" enctype="multipart/form-data">
                                        <input type="hidden" class="form-control" id="id" value="<?php echo $data['docs']['id'];?>"  name="id">
                                        <input type="hidden" class="form-control" id="filename" value="<?php echo $data['docs']['filename'];?>"  name="filename">
                                        <div class="form-group">
                                            <label for="title">Title</label>
                                            <input type="text" class="form-control" name="title" id="title" value="<?php echo $data['docs']['title'];?>" placeholder="Title">
                                        </div>
                                        <div class="form-group">
                                            <label for="description">Description</label>
                                            <textarea class="form-control" id="description" name="description"><?php echo $data['docs']['description'];?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="authors">Author(s)</label>
                                            <input type="text" class="form-control" value="<?php echo $data['docs']['authors'];?>" name="authors" id="authors" placeholder="Author(s)">
                                        </div>
                                        <div class="form-group">
                                            <label for="year">Publication Date</label>
                                            <input type="text" class="form-control" name="year" id="year" value="<?php echo $data['docs']['pub_year'];?>" placeholder="Month Day, Year">
                                        </div>
                                        <div class="form-group">
                                            <label for="publisher">Publisher</label>
                                            <input type="text" class="form-control" name="publisher" id="publisher" value="<?php echo $data['docs']['publisher'];?>" placeholder="Publisher">
                                        </div>
                                        <div class="form-group">
                                            <label for="file_category">Select Status</label>
                                            <select class="form-control" id="status" name="status">
                                                <?php foreach ($data['states'] as $state): ?>
                                                    <?php if($state['state'] == $data['docs']['state']) { ?>
                                                            <option value="<?php echo $state['id'];?>" selected="selected"><?php echo $state['state'];?></option>
                                                    <?php } else { ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="doc_category" name="doc_category">
                                                <?php foreach ($data['categories'] as $category): ?>
                                                    <?php if($category['category'] == $data['docs']['category']) { ?>
                                                            <option value="<?php echo $category['id'];?>" selected="selected"><?php echo $category['category'];?></option>
                                                    <?php } else { ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="file_category" name="file_category">
                                                <?php foreach ($data['files'] as $file): ?>
                                                    <?php if($file['file'] == $data['docs']['file']) { ?>
                                                            <option value="<?php echo $file['id'];?>" selected="selected"><?php echo $file['file'];?></option>
                                                    <?php } else { ?>
                                        ...
                                        <div id="dragndrop" ondrop="upload_file(event)" ondragover="return false">
                                            ...
                                            <p>File Name:</p>
                                            <p id="actual-file-name"><?php echo $data['docs']['filename'];?></p>
                                        </div>                                  
                                    <div class="col-12 p-0 m-0 mt-4">
                                        ...
                                        <div class="card button-card border-top-bottom-blue">  <!-- <div class="card text-white bg-dark"> -->
                                            ...
                                            <div class="card-body button-card-body">
                                                <input type="submit" name="submit" id="submit" value="Delete Document" class="btn btn-sm btn-primary px-2 rounded">
