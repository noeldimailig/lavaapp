                            ...
                            <div class="card-deck">
                                ...
                                <div class="card border-top-bottom-blue">  <!-- <div class="card text-white bg-dark"> -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        ?>
                                         <!-- Form -->
                                    <form action="<?php echo site_url('nav/document_update'); ?>" method="post" class="outer-form" id="validate" enctype="multipart/form-data">
                                    ...
                                    <div class="col-12 p-0 m-0 mt-4">
                                        ...
                                        <div class="card button-card border-top-bottom-blue">  <!-- <div class="card text-white bg-dark"> -->
                                            ...
                                            <div class="card-body button-card-body">
                                                <input type="submit" name="submit" id="submit" value="Update Details" class="btn btn-sm btn-primary px-2 rounded">
