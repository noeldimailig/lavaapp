...
<html lang="en">
      ...
      <div class="row">
        ...
        <nav id="sidebarToggler" class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse pt-0 pb-5">
            ...
            <ul class="nav flex-column">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" href="<?php echo site_url('nav/campus'); ?>">
        ...
        <main role="main" class="main col-md-9 ml-sm-auto col-lg-10 px-md-4">
            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo site_url('nav/campus'); ?>"><i class="fa fa-home"></i> Manage Campuses</a></li>
            ...
            <div class="row d-flex flex-row px-3 mb-4">
                <div class="col-3 p-0 mx-auto">
                    <div class="card-header">Add Campus</div>
                    <div class="card p-3 border-top-bottom-blue">
                        <form action="<?php echo site_url('nav/campus_insert'); ?>" method="post" class="outer-form" id="add-campus">
                            <div class="form-group">
                                <label for="campus">Campus</label>
                                <input type="text" class="form-control" name="campus" id="campus" placeholder="Campus">
                            </div>
                            <div class="form-group">
                                <input type="submit" name="submit" id="submit" value="Add Campus" class="btn btn-sm btn-primary px-2 rounded">
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-3 p-0 mx-auto">
                    <div class="card-header">Update Campus</div>
                    <div class="card p-3 border-top-bottom-blue">
                        <form action="<?php echo site_url('nav/campus_update'); ?>" method="post" class="outer-form" id="update-campus">
                            <input type="hidden" class="form-control" id="id" value="<?php echo $data['campus']['id'];?>"  name="id">
                            <div class="form-group">
                                <label for="campus">Campus</label>
                                <input type="text" class="form-control" name="campus" id="campus" placeholder="Campus" value="<?php echo $data['campus']['campus']; ?>">
                            </div>
                            <div class="form-group">
                                <input type="submit" name="update" id="update" value="Update Campus" class="btn btn-sm btn-warning px-2 rounded">
                            </div>
                        </form>
                    </div>
                </div>
                <div class="col-3 p-0 mx-auto">
                    <div class="card-header">Delete Campus</div>
                    <div class="card p-3 border-top-bottom-blue">
                        <form action="<?php echo site_url('nav/campus_delete'); ?>" method="post" class="outer-form" id="delete-campus">
                            <input type="hidden" class="form-control" id="id" value="<?php echo $data['campus']['id'];?>"  name="id">
                            <div class="form-group">
                                <label for="campus">Campus</label>
                                <input type="text" class="form-control" name="campus" id="campus" placeholder="Campus" value="<?php echo $data['campus']['campus'];?>">
                            ...
                            <div class="form-group">
                                <input type="submit" name="delete" id="delete" value="Delete Campus" class="btn btn-sm btn-danger px-2 rounded">
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-0 pb-2 mb-3 border-bottom">
                <h5 class="h3 color-darkgray mt-0 mb-0">Campus Lists</h5>
            </div>
            <!-- end title -->
                    ...
                    <div class="card border-top-bottom-blue">  <!-- <div class="card text-white bg-dark"> -->
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered table-hover table-sm mb-0">
                                ...
                                <tbody>
                                    <?php foreach ($data['campuses'] as $result) : ?>
                                        <?php if($result['id'] != 4) { ?>
                                            <tr>
                                                <td><?php echo $result['id']; ?></td>
                                                <td><?php echo $result['campus']; ?></td>
                                                <td>
                                                  <a class="btn btn-sm btn-primary px-2 rounded" role="button" href="<?php echo site_url('nav/update_campus/'.encrypt_id($result['id']));?>">Update</a>
                                                  <a class="btn btn-sm btn-danger px-2 rounded" role="button" href="<?php echo site_url('nav/delete_campus/'.encrypt_id($result['id']));?>">Delete</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                     <?php endforeach ?>
  ...
  <script>
      ...
      $('#update-campus').submit(function(e) {
        //e.preventDefault();
        var form = $(this);
        var url = form.attr('action');
        $.ajax({
      ...
      $('#delete-campus').submit(function(e) {
        //e.preventDefault();
        var form = $(this);
        var url = form.attr('action');
        $.ajax({
