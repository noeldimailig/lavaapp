        ...
        <main role="main" class="main col-md-9 ml-sm-auto col-lg-10 px-md-4">
            ...
            <div class="container-fluid">
                ...
                <div class="row pb-5">
                    ...
                    <!-- Form -->
                    <form action="<?php echo site_url('nav/delete_admin_data'); ?>" method="post" class="outer-form" id="validate" enctype="multipart/form-data">
                        <!-- col-12 -->
                        ...
                        <div class="col-12 p-0 m-0 mt-4">
                            ...
                            <div class="card button-card border-top-bottom-blue">  <!-- <div class="card text-white bg-dark"> -->
                                ...
                                <div class="card-body button-card-body">
                                    <input type="submit" id="submit" name="submit" value="Delete Admin" class="btn btn-sm btn-primary px-2 rounded">
