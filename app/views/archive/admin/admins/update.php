      ...
      <div class="row">
        ...
        <main role="main" class="main col-md-9 ml-sm-auto col-lg-10 px-md-4">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-0 pb-2 mb-3 border-bottom">
                <h5 class="h3 color-darkgray mt-0 mb-0"> Form <small>Update Admin Details</small></h5>
            ...
            <div class="container-fluid">
                ...
                <div class="row pb-5">
                    ...
                    <!-- Form -->
                    <form action="<?php echo site_url('nav/update_admin_data'); ?>" method="post" class="outer-form" id="validate" enctype="multipart/form-data">
                        <!-- col-12 -->
                        <div class="col-12 p-0 m-0 mt-0">
                            ...
                            <div class="card-deck">
                                ...
                                <div class="card border-top-bottom-blue">  <!-- <div class="card text-white bg-dark"> -->
                                    ...
                                    <!-- Card Body -->
                                    <div class="card-body">
                                        <input type="hidden" class="form-control" name="passwords" id="passwords" value="<?php foreach($data['admin'] as $results){ echo $results['password'];}?>">
                                        <input type="hidden" class="form-control" id="id" value="<?php foreach($data['admin'] as $results){ echo $results['id'];}?>"  name="id">
                                        <input type="hidden" class="form-control" id="prev_filename" value="<?php foreach($data['admin'] as $results){ echo $results['profile'];}?>"  name="prev_filename">
                                        <div class="form-group">
                                            <label for="name">Full Name</label>
                                            <input type="text" class="form-control" name="name" id="name" placeholder="Juan Dela Cruz" value="<?php foreach($data['admin'] as $results){ echo $results['username'];}?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="email">Email</label>
                                            <input type="email" class="form-control" name="email" id="email" placeholder="sample@email.com" value="<?php foreach($data['admin'] as $results){ echo $results['email'];}?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="password">Password</label>
                                            <input type="password" class="form-control" name="password" id="password" placeholder="Password" value="<?php foreach($data['admin'] as $results){ echo $results['password'];}?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="confirm_password">Confirm Password</label>
                                            <input type="password" class="form-control" name="confirm_password" id="confirm_password" placeholder="Confirm Password" value="<?php foreach($data['admin'] as $results){ echo $results['password'];}?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="campuses" name="campus">
                                                <?php foreach ($data['campuses'] as $campus): ?>
                                                    <?php if($campus['campus'] == $results['campus']) { ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="department" name="department">
                                                <?php foreach ($data['departments'] as $department): ?>
                                                    <?php if($department['dep'] == $results['dep']) { ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="program" name="program">
                                                <?php foreach ($data['programs'] as $program): ?>
                                                   <?php if($program['program'] == $results['program']) { ?>
                                        ...
                                        <div class="form-group d-flex flex-row align-items-center">
                                            ...
                                            <div class="fileName d-flex flex-row align-items-center border-bottom border-dark">
                                                ...
                                                <p class="m-1" id="actual-file-name"><?php echo $results['profile'];?></p>
                                            </div>
                                        </div>  
                        ...
                        <div class="col-12 p-0 m-0 mt-4">
                            ...
                            <div class="card button-card border-top-bottom-blue">  <!-- <div class="card text-white bg-dark"> -->
                                ...
                                <div class="card-body button-card-body">
                                    <input type="submit" id="submit" name="submit" value="Update Details" class="btn btn-sm btn-primary px-2 rounded">
