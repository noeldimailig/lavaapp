      ...
      <div class="row">
        ...
        <main role="main" class="main col-md-9 ml-sm-auto col-lg-10 px-md-4">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-0 pb-2 mb-3 border-bottom">
                <h5 class="h3 color-darkgray mt-0 mb-0">User Lists</h5>
            </div>
            <!-- end title -->
                                ...
                                <tbody>
                                    <?php foreach ($data['users'] as $result) : ?>
                                        <tr>
                                            ...
                                            <td>
                                              <a class="btn btn-sm btn-danger px-2 rounded" role="button" href="<?php echo site_url('nav/delete_user/'.encrypt_id($result['id'])); ?>">Delete</a>
                                            </td>
                                        </tr>
                                     <?php endforeach ?>
                                        </tbody>
