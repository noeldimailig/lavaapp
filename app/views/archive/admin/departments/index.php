...
<html lang="en">
      ...
      <div class="row">
        ...
        <nav id="sidebarToggler" class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse pt-0 pb-5">
            ...
            <ul class="nav flex-column">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" href="<?php echo site_url('nav/department'); ?>">
        ...
        <main role="main" class="main col-md-9 ml-sm-auto col-lg-10 px-md-4">
            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo site_url('nav/department'); ?>"><i class="fa fa-home"></i> Manage Departments</a></li>
            ...
            <div class="row d-flex flex-row px-3 mb-4">
                <div class="col-3 p-0 mx-auto">
                    ...
                    <div class="card p-3 border-top-bottom-blue">
                        <form action="<?php echo site_url('nav/department_insert'); ?>" method="post" class="outer-form" id="add-department">
                            <div class="form-group">
                                <label for="department">Department</label>
                                <input type="text" class="form-control" name="department" id="department" placeholder="Department">
                            </div>
                            <div class="form-group">
                                <input type="submit" name="submit" id="submit" value="Add Department" class="btn btn-sm btn-primary px-2 rounded">
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-3 p-0 mx-auto">
                    ...
                    <div class="card p-3 border-top-bottom-blue">
                        <form action="<?php echo site_url('nav/department_update'); ?>" method="post" class="outer-form" id="update-department">
                            <input type="hidden" class="form-control" id="id" value="<?php echo $data['department']['id'];?>"  name="id">
                            <div class="form-group">
                                <label for="department">Department</label>
                                <input type="text" class="form-control" name="department" id="department" placeholder="Department" value="<?php echo $data['department']['dep']; ?>">
                            </div>
                            <div class="form-group">
                                <input type="submit" name="update" id="update" value="Update Department" class="btn btn-sm btn-warning px-2 rounded">
                            </div>
                        </form>
                    </div>
                </div>
                <div class="col-3 p-0 mx-auto">
                    ...
                    <div class="card p-3 border-top-bottom-blue">
                        <form action="<?php echo site_url('nav/department_delete'); ?>" method="post" class="outer-form" id="delete-department">
                            <input type="hidden" class="form-control" id="id" value="<?php echo $data['department']['id'];?>"  name="id">
                            <div class="form-group">
                                <label for="department">Department</label>
                                <input type="text" class="form-control" name="department" id="department" placeholder="Department" value="<?php echo $data['department']['dep'];?>">
                            ...
                            <div class="form-group">
                                <input type="submit" name="delete" id="delete" value="Delete Department" class="btn btn-sm btn-danger px-2 rounded">
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-0 pb-2 mb-3 border-bottom">
                <h5 class="h3 color-darkgray mt-0 mb-0">Department Lists</h5>
            </div>
            <!-- end title -->
                    ...
                    <div class="card border-top-bottom-blue">  <!-- <div class="card text-white bg-dark"> -->
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered table-hover table-sm mb-0">
                                ...
                                <tbody>
                                    <?php foreach ($data['departments'] as $result) : ?>
                                        <?php if($result['id'] != 4) { ?>
                                            <tr>
                                                <td><?php echo $result['id']; ?></td>
                                                <td><?php echo $result['dep']; ?></td>
                                                <td>
                                                  <a class="btn btn-sm btn-primary px-2 rounded" role="button" href="<?php echo site_url('nav/update_department/'.encrypt_id($result['id']));?>">Update</a>
                                                  <a class="btn btn-sm btn-danger px-2 rounded" role="button" href="<?php echo site_url('nav/delete_department/'.encrypt_id($result['id']));?>">Delete</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                     <?php endforeach ?>
  ...
  <script>
      ...
      $('#update-department').submit(function(e) {
        //e.preventDefault();
        var form = $(this);
        var url = form.attr('action');
        $.ajax({
      ...
      $('#delete-department').submit(function(e) {
        //e.preventDefault();
        var form = $(this);
        var url = form.attr('action');
        $.ajax({
