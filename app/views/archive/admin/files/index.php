      ...
      <div class="row">
        ...
        <nav id="sidebarToggler" class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse pt-0 pb-5">
            ...
            <ul class="nav flex-column">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" href="<?php echo site_url('nav/file'); ?>">
        ...
        <main role="main" class="main col-md-9 ml-sm-auto col-lg-10 px-md-4">
            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo site_url('nav/file'); ?>"><i class="fa fa-paste"></i> Manage File Category</a></li>
            ...
            <div class="row d-flex flex-row px-3 mb-4">
                <div class="col-3 p-0 mx-auto">
                    ...
                    <div class="card p-3 border-top-bottom-blue">
                        <form action="<?php echo site_url('nav/file_insert'); ?>" method="post" class="outer-form" id="add-file">
                            <div class="form-group">
                                <label for="dept">File Category</label>
                                <input type="text" class="form-control" name="file" id="file" placeholder="File Category">
                            </div>
                            <div class="form-group">
                ...
                <div class="col-3 p-0 mx-auto">
                    ...
                    <div class="card p-3 border-top-bottom-blue">
                        <form action="<?php echo site_url('nav/file_update'); ?>" method="post" class="outer-form" id="validate">
                            <input type="hidden" class="form-control" id="id" value="<?php echo $data['file']['id'];?>"  name="id">
                            <div class="form-group">
                                <label for="dept">File Category</label>
                                <input type="text" class="form-control" name="file" id="file" placeholder="File Category" value="<?php echo $data['file']['file'];?>">
                            </div>
                            <div class="form-group">
                ...
                <div class="col-3 p-0 mx-auto">
                    ...
                    <div class="card p-3 border-top-bottom-blue">
                        <form action="<?php echo site_url('nav/file_delete'); ?>" method="post" class="outer-form" id="validate">
                            <input type="hidden" class="form-control" id="id" value="<?php echo $data['file']['id'];?>"  name="id">
                            <div class="form-group">
                                <label for="dept">File Category</label>
                                <input type="text" class="form-control" name="file" id="file" placeholder="File Category" value="<?php echo $data['file']['file'];?>">
                                    ...
                                    <?php 
                                        ...
                                        <?php if($result['id'] != 1) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                  <a class="btn btn-sm btn-primary px-2 rounded" role="button" href="<?php echo site_url('nav/update_file/'.encrypt_id($result['id']));?>">Update</a>
                                                  <a class="btn btn-sm btn-danger px-2 rounded" role="button" href="<?php echo site_url('nav/update_file/'.encrypt_id($result['id']));?>">Delete</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                     <?php endforeach ?>
