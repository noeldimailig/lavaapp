            ...
            <div class="container-fluid">
                ...
                <div class="row pb-3">
                    ...
                    <div class="col-12 p-0 m-0 mt-0 mb-3">
                        <div class="card-header text-center font-weight-bold">All Messages</div>
                        <div class="card-body p-0">
                            <div class="card-body">
                                <a href="view_message.php" class="text-decoration-none">
                                    <div class="mb-2 border border-success d-flex flex-row align-items-center p-2 text-dark">
                                 ...
                                 <a href="view_message.php" class="text-decoration-none">
                                    <div class="mb-2 border border-success d-flex flex-row align-items-center p-2 text-dark">
                                        <img style="width: 45px;height: 45px; border: 2px solid grey; border-radius: 10%;" src="./assets/img/icon.png" class="mx-2" />
                                        <p class="p-0 m-0">
                                            <b>Axel</b> Lorem ipsum dolor sit, amet consectetur, adipisicing elit. Ratione placeat, illum officia eius tempora consectetur quidem minus quisquam inventore itaque voluptatem modi neque tenetur explicabo, maiores impedit quae corrupti, dolore.
                                            <br>
                                            <small>10 minutes ago</small>
