...
<head>
  ...
  <title>Thesis - Elite Researcher</title>
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          <div class="col-lg-8">
            ...
            <?php foreach ($data['docs'] as $doc) : 
                  if($doc['category'] == 'Thesis'): $modal_id[] = ''.$doc['id']; ?>
                        ...
                        <div class="col-lg-12">
                          ...
                          <div class="d-flex flex-row justify-content-between align-items-between border-top" id="options">
                            ...
                            <div class="mt-2 d-flex flex-row justify-content-between align-items-between">
                              ...
                              <form id="saveform<?php echo $doc['id']; ?>" action="" method="post" class="d-flex flex-row justify-content-between align-items-center p-0 m-0">
          ...
          <div class="col-lg-4">
            <div class="col-12 mb-3 contact">
              <form id="search-form" action="<?php echo site_url('search/thesis'); ?>" class="php-email-forms" method="post">
